 ...
 * imports.
 *
 * With nothing recorded at copy time, "differs from the registry" is the
 * closest available stand-in for "you changed this" — it also fires when only
 * upstream moved. That is the safe direction to be wrong in: the worst case is
 * asking for `--force` on a file the user did not touch.
 */
